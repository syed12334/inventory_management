                            ...
                            <form action="#" class="dropdown">
                                <div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                    ...
                                    <span class="input-group-text">
                                        <kbd class="d-flex align-items-center"><img src="{{ asset('img/icons/command.svg');}}" alt="img" class="me-1">K</kbd>
                                    </span>
                                </div>
                                ...
                                <ul class="notification-list">
                                        ...
                                        <a href="activities.html">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0">
                                                    <img alt="Img" src="{{ asset('img/profiles/avatar-13.jpg');}}">
                                                </span>
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0">
                                                    <img alt="Img" src="{{asset('img/profiles/avatar-03.jpg');}}">
                                                </span>
                                                <div class="flex-grow-1">
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html" class="recent-msg">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0">
                                                    <img alt="Img" src="{{asset('img/profiles/avatar-17.jpg');}}">
                                                </span>
                                                <div class="flex-grow-1">
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html" class="recent-msg">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0">
                                                    <img alt="Img" src="{{ asset('img/profiles/avatar-02.jpg');}}">
                                                </span>
                                                <div class="flex-grow-1">
                    ...
                    <ul>
                        ...
                        <li class="submenu-open">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('brand.index')}}"><i class="ti ti-triangles fs-16 me-2"></i><span>Brands</span></a></li>
                                <li><a href="{{route('unit.index')}}"><i class="ti ti-brand-unity fs-16 me-2"></i><span>Units</span></a></li>
